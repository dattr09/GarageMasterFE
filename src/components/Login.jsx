    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          onClick={() => setOauthMessage("Tính năng đăng nhập Google sẽ sớm có!")}
        >
          <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" className="w-6 h-6" />
          <span className="font-semibold text-gray-700 text-sm">Đăng nhập với Google</span>
        </button>
        <button
          type="button"
          ...
          onClick={() => setOauthMessage("Tính năng đăng nhập Apple sẽ sớm có!")}
        >
          ...
          <span className="font-semibold text-white text-sm">Đăng nhập với Apple</span>
        </button>
      </div>
